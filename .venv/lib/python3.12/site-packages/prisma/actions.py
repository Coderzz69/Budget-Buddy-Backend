...
class UserActions(Generic[_PrismaModelT]):
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second User record ordered by the phoneNumber field
...
class AccountActions(Generic[_PrismaModelT]):
    ...
    def find_many(
        ...
        # find the first 5 Account records ordered by the name field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Account records by name values
        # and count how many records are in each group
...
class CategoryActions(Generic[_PrismaModelT]):
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Category record ordered by the icon field
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Category record ordered by the color field
...
class TransactionActions(Generic[_PrismaModelT]):
    ...
    def create(
        ...
        transaction = Transaction.prisma().create(
            data={
                ...
                'userId': 'bghfciaafe',
                'accountId': 'bgchfhgceh',
                'type': 'cafeiaccbc',
                'amount': 60335757.68446,
    ...
    def find_unique_or_raise(
        ...
        -------
        ```py
        transaction = Transaction.prisma().find_unique_or_raise(
            where={
                'id': 'febcgjbfj',
            },
        )
    ...
    def find_many(
        ...
        # find the first 5 Transaction records ordered by the accountId field
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Transaction record ordered by the categoryId field
    ...
    def find_first_or_raise(
        ...
        transaction = Transaction.prisma().find_first_or_raise(
            skip=1,
            order={
                'type': 'desc',
            },
...
class BudgetActions(Generic[_PrismaModelT]):
    ...
    def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = Budget.prisma().query_first(
    ...
    def create(
        ...
        budget = Budget.prisma().create(
            data={
                # data to create a Budget record
                'userId': 'hgjcghfbi',
                'categoryId': 'icadbcehj',
                'month': datetime.datetime.utcnow(),
                'limit': 92728044.34485,
            },
        )
        ```
        """
    ...
    def create_many(
        ...
        *,
        ...
        -------
        ```py
        total = Budget.prisma().create_many(
            data=[
                {
                    # data to create a Budget record
                    'userId': 'bbcbhebbda',
                    'categoryId': 'bejfijgcfb',
                    'month': datetime.datetime.utcnow(),
                    'limit': 208521688.86081,
                },
                {
                    # data to create a Budget record
                    'userId': 'bggajdcbbi',
                    'categoryId': 'fcfhgbjed',
                    'month': datetime.datetime.utcnow(),
                    'limit': 736209796.49390,
                },
            ],
            skip_duplicates=True,
        )
    ...
    def find_unique(
        ...
        -------
        ```py
        budget = Budget.prisma().find_unique(
            where={
                'id': 'gfeaahdeh',
            },
        )
    ...
    def find_unique_or_raise(
        ...
        -------
        ```py
        budget = Budget.prisma().find_unique_or_raise(
            where={
                'id': 'bjafcgbffc',
            },
        )
    ...
    def find_many(
        ...
        budgets = Budget.prisma().find_many(take=10)

        # find the first 5 Budget records ordered by the categoryId field
        budgets = Budget.prisma().find_many(
            take=5,
            order={
                'categoryId': 'desc',
            },
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Budget record ordered by the month field
        budget = Budget.prisma().find_first(
            skip=1,
            order={
                'month': 'desc',
            },
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Budget record ordered by the limit field
        budget = Budget.prisma().find_first_or_raise(
            skip=1,
            order={
                'limit': 'desc',
            },
    ...
    def update_many(
        ...
        total = Budget.prisma().update_many(
            data={
                'createdAt': datetime.datetime.utcnow()
            },
            where={}
    ...
    def count(
        ...
        ```py
        # total: int
        total = Budget.prisma().count()

        # results: prisma.types.BudgetCountAggregateOutput
        results = Budget.prisma().count(
            select={
                '_all': True,
                'id': True,
            },
    ...
    def delete_many(
        ...
        total = Budget.prisma().delete_many()
        ```
        """
        resp = self._client._execute(
            method='delete_many',
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Budget records by categoryId values
        # and count how many records are in each group
        results = Budget.prisma().group_by(
            ['categoryId'],
            count=True,
        )
        ```
